# Example text has been edited to fit a more toxicological context
# source example text: Klaassen, C. D., & Watkins, J. B. (2021). Casarett & Doull’s Essentials of Toxicology.
...
class FaithfulnessTemplate:
    ...
    def generate_claims(actual_output: str, multimodal: bool = False):
        ...
        return textwrap.dedent(
            ...
            {{
                "claims": [
                    "A regulatory toxicologist determines from available data whether a chemical poses a sufficiently low risk to be marketed for a stated purpose.",
                    "A regulatory toxicologist establishes standards for the amount of chemicals permitted in ambient air, industrial atmospheres, and drinking water."
                ]  
            }}
            ===== END OF EXAMPLE ======
    ...
    def generate_verdicts(
        ...
        if multimodal:
            example_section = textwrap.dedent(
                """
                Example retrieval contexts: "A regulatory toxicologist both determines from available data whether a chemical poses a sufficiently low risk to be marketed for a stated purpose and establishes standards for the amount of chemicals permitted in ambient air, industrial atmospheres, and drinking water."
                Example claims: ["Exposure concentrations ranged from 0.1 nanomolars to 10 micromolars", "Zurich is a city in London", "A regulatory toxicologist establishes standards for the amount of chemicals permitted in ambient air, industrial atmospheres, and drinking water.", "A regulatory toxicologist markets chemicals for a stated purpose.", "A regulatory toxicologist determines risk based on thinking really hard"]

                Example:
                {{
                    "verdicts": [
                        {{
                            "reason": "The claim about Exposure concentrations is not directly addressed in the retrieval context, and so poses no contradiction.",
                            "verdict": "idk"
                        }},
                        {{
                        ...
                        {{
                            "reason": "The actual output claims a regulatory toxicologist markets chemicals for a stated purpose, which is untrue as the retrieval context states a regulatory toxicologist determines whether a chemical poses a sufficiently low risk to be marketed for a stated purpose instead.",
                            "verdict": "no"
                        }},
                        {{
                            "reason": "The actual output claims a regulatory toxicologist determines risk based on thinking really hard, which is not correct as the retrieval context states A regulatory toxicologist determines risk from available data"
                            "verdict": "no"
                        }}
                    ]  
                }}
