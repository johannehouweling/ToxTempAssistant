...
OUTPUT_CSV = ROOT / 'myocyte' / 'toxtempass' / 'evaluation' / 'data_analysis_plotting' / 'christophe_data_analysis' / 'results' / 'tables' / 'completeness_tier3' / 'v1_no_description' / 'summary_completeness_v1_nodescription.csv'
...
CURRENT_LOC = ROOT / 'myocyte' / 'toxtempass' / 'evaluation' / 'data_analysis_plotting' / 'christophe_data_analysis' / 'scripts' / 'tier3' / 'completeness' / 'no_description' / 'summary.py'
...
doc_type_line = px.line(
    ...
    y='mean_answer_given',
    color='doc_type',
    title='v1. Completeness of ToxTemp per section per document type',
...
assay_line = px.line(
    ...
    y='mean_answer_given',
    color='assay',
    title='v1. Completeness of ToxTemp per section per assay',
    category_orders={"section_short": section_order},
    markers=True
)
...
model_line = px.line(
    ...
    y='mean_answer_given',
    color='model',
    title='v1. Completeness of ToxTemp per section per LLM model',
    category_orders={"section_short": section_order},
    markers=True
)
...
for doc_type in doc_model_completeness_df["doc_type"].unique():
    globals()[f"{doc_type}_model_line"] = px.line(
        ...
        y='mean_answer_given',
        color='model',
        title=f'v1. Completeness of ToxTemp per section per LLM model for {doc_type}s',
        category_orders={"section_short": section_order},
        markers=True
    )
