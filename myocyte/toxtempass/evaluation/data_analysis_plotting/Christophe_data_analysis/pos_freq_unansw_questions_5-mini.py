...
OUTPUT_CSV = Path("myocyte/toxtempass/evaluation/data_analysis_plotting/Christophe_data_analysis/summary_answer_freq_5mini.csv")
...
#plt.tilte ("5-mini question answer frequency")
